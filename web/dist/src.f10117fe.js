...
function () {
  function Attributes(data) {
    ...
    this.data = data; // sintaxis para poder tener los types segun cada Key correspondiente de T
...
function () {
  ...
  Model.prototype.fetch = function () {
    ...
    if (typeof id !== "number") {
      throw new Error("Cannot fetch withput an id");
    }
...
exports.User = User;
},{"./Eventing":"src/models/Eventing.ts","./ApiSync":"src/models/ApiSync.ts","./Attributes":"src/models/Attributes.ts","./Collection":"src/models/Collection.ts","./Model":"src/models/Model.ts"}],"src/views/CollectionsView.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  CollectionView.prototype.render = function () {
    ...
    var templateElememt = document.createElement("template");
    ...
    for (var _i = 0, _a = this.collection.models; _i < _a.length; _i++) {
      ...
      templateElememt.content.append(itemParent);
    }

    this.parent.append(templateElememt.content);
  };
...
var CollectionsView_1 = require("./CollectionsView");
...
function (_super) {
  ...
  return UserList;
}(CollectionsView_1.CollectionView);

exports.UserList = UserList;
},{"./CollectionsView":"src/views/CollectionsView.ts","./UserShow":"src/views/UserShow.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
user.on("change", function () {
  ...
  if (root) {
    console.log(user);
    new UserList_1.UserList(root, user).render();
  }
});
user.fetch();
},{"./models/Collection":"src/models/Collection.ts","./models/Users":"src/models/Users.ts","./views/UserList":"src/views/UserList.ts"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
